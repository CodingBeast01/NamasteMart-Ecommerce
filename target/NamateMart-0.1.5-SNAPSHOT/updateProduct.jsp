...
<%@ page import="com.namastemart.service.impl.*, com.namastemart.beans.*, com.namastemart.service.*, java.util.*, javax.servlet.ServletOutputStream, java.io.*"%>
<!DOCTYPE html>
<html>
<head>
...
if (prodid == null || product == null) {
    response.sendRedirect("updateProductById.jsp?message=Please Enter a valid productId");
    return;
    ...
    <div class="form-container col-md-6 col-md-offset-3">
        <form action="./UpdateProductSrv" method="post" >
            ...
            <div class="form-group">
                ...
                <textarea name="info" class="form-control" id="product_description" required><%= product.getProdInfo() %></textarea>
            </div>
            <div class="row">
                <div class="col-md-6 form-group">
