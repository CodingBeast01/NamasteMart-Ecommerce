...
<div class="container">
    ...
    <thead style="background-color: #1e73b4; color: white; font-size: 14px; font-weight: bold;">
    <tr>
        <th>Picture</th>
        <th>Product Name</th>
        <th>Order ID</th>
    ...
    <tr>
        ...
        %>
            <a href="orderCancel.jsp?orderId=<%=order.getOrderId()%>" class="btn btn-danger btn-sm">Cancel</a>
        <%
        } else {
        %>
